...
class DendriticNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        nn.init.kaiming_normal_(
            self.output_layer.weight, mode="fan_in", nonlinearity="leaky_relu"
        )
        if output_bias:
    ...
    def num_params(self):
        ...
        print(
            f"Total parameters: {total} (Dendritic: {dendritic_params}, Output: {output_params})"
        )
        return total
